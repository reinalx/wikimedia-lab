...
import com.learn.wikimedialab.domain.exceptions.base.BaseWikimediaLabException;
...
class GlobalExceptionHandlerTest {
	...
	void handleBaseVisitsException_ShouldReturnInternalServerErrorResponse() {
		// Given
		final BaseWikimediaLabException mockException = mock(BaseWikimediaLabException.class);
		...
		// When
		final ResponseEntity<Map<String, String>> response = this.globalExceptionHandler
				.handleVisitsException(mockException);
